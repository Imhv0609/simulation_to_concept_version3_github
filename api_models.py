...
class StartSessionRequest(BaseModel):
    ...
    simulation_id: str = Field(
        ..., 
        description="ID of simulation: 'simple_pendulum', 'simple_pendulum_new', 'earth_rotation_revolution', 'light_shadows', 'time_units', 'speed_race', 'speed_calculator', 'brackets_signs', etc."
    )
